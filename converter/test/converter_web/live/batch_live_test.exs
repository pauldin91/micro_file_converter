defmodule ConverterWeb.BatchLiveTest do
  use ConverterWeb.ConnCase

  import Phoenix.LiveViewTest
  import Converter.BatchesFixtures

  @create_attrs %{status: "some status", timestamp: "2025-11-10T19:34:00Z"}
  @update_attrs %{status: "some updated status", timestamp: "2025-11-11T19:34:00Z"}
