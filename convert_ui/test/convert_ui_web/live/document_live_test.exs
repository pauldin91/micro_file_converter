defmodule ConvertUiWeb.DocumentLiveTest do
  use ConvertUiWeb.ConnCase

  import Phoenix.LiveViewTest
  import ConvertUi.DocsFixtures

  @create_attrs %{name: "some name", path: "some path", mime_type: "some mime_type", uploaded_at: "2025-11-04T19:22:00"}
  @update_attrs %{name: "some updated name", path: "some updated path", mime_type: "some updated mime_type", uploaded_at: "2025-11-05T19:22:00"}
